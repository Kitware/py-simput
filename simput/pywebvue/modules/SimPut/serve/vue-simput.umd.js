...
/* harmony default export */ var SimputItem_scriptvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    this.onReload = function (name) {
      if (name === 'data') {
        _this.data = _this.getSimput().getData(_this.itemId, true);
      }

      if (name === 'ui') {
        _this.ui = _this.getSimput().getUI(_this.itemId, true);
      }

      if (name === 'domain') {
        _this.domains = _this.getSimput().getDomains(_this.itemId, true);
      }
    };
...
var templatevue_type_template_id_2c018106_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-col',{directives:[{name:"show",rawName:"v-show",value:(_vm.decorator.show),expression:"decorator.show"}],staticClass:"py-0"},[_c('v-select',{key:_vm.tsKey,attrs:{"label":_vm.label,"hint":_vm.computedHelp,"items":_vm.computedItems,"multiple":_vm.multiple,"persistent-hint":!!(_vm.useRangeHelp || _vm.help),"disabled":!_vm.decorator.enable},on:{"change":_vm.validate},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v},expression:"model"}})],1)}
...
var templatevue_type_template_id_2059aedf_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-textarea',{directives:[{name:"show",rawName:"v-show",value:(_vm.decorator.show),expression:"decorator.show"}],attrs:{"label":_vm.label,"hint":_vm.help,"auto-grow":_vm.auto-_vm.grow,"autofocus":_vm.autofocus,"clearable":_vm.clearable,"disabled":_vm.disabled,"no-resize":_vm.no-_vm.resize,"row-height":_vm.row-_vm.height,"rows":_vm.rows,"disabled":!_vm.decorator.enable},on:{"change":_vm.validate},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v},expression:"model"}})}
